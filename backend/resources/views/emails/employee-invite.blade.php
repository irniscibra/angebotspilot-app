...
<div class="card">
    ...
    <div class="content">
        ...
        <div class="info-text">
            <strong>{{ $invitedByName }}</strong> hat Sie eingeladen, dem Team von
            <strong>{{ $companyName }}</strong> auf AngebotsPilot beizutreten.<br><br>
            Legen Sie jetzt Ihr Passwort fest, um loszulegen.
        </div>
