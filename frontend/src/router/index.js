...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'quotes', name: 'quotes', component: () => import('pages/QuotesListPage.vue') },
      { path: 'quotes/create', name: 'quotes-create', component: () => import('pages/QuoteCreatePage.vue') },
      { path: 'quotes/:id', name: 'quotes-show', component: () => import('pages/QuoteDetailPage.vue') },
      ...
      { path: 'datanorm', name: 'datanorm', component: () => import('pages/DatanormImportPage.vue') },
      {path: 'vorlagen',name: 'vorlagen',component: () => import('pages/ServiceTemplatesPage.vue')},
